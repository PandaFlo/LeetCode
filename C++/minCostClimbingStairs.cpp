...
void tester() {
    ...
    // Test cases
    std::vector<int> testCases1 = {10, 15, 20};
    std::vector<int> testCases2 = {1, 100, 1, 1, 1, 100, 1, 1, 100, 1};

    int result1 = solution.minCostClimbingStairs(testCases1);
    int result2 = solution.minCostClimbingStairs(testCases2);

    std::cout << "Minimum cost for test case 1: " << result1 << std::endl;
    std::cout << "Minimum cost for test case 2: " << result2 << std::endl;
}
