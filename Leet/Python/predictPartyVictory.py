...
class Solution(object):
    def predictPartyVictory(self, senate):
        ...
        """
        n = len(senate)
        radiant_queue = []  # Queue to store indices of Radiant senators
        dire_queue = []     # Queue to store indices of Dire senators
        ...
        while radiant_queue and dire_queue:
            radiant_idx = radiant_queue.pop(0)
            dire_idx = dire_queue.pop(0)
