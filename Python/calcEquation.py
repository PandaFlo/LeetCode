...
solution = Solution()
output2 = solution.calcEquation(equations2, values2, queries2)
print(output2)  # Output: [3.75, 0.4, 5.0, 0.2]
...
solution = Solution()
output3 = solution.calcEquation(equations3, values3, queries3)
print(output3)  # Output: [0.5, 2.0, -1.0, -1.0]
