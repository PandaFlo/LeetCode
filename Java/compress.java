...
public class compress {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(Arrays.copyOf(chars1, newLength1)));
        
        char[] chars2 = {'a'};
        int newLength2 = solution.compress(chars2);
        System.out.println(newLength2);
        System.out.println(Arrays.toString(Arrays.copyOf(chars2, newLength2)));
        
        char[] chars3 = {'a', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b', 'b'};
        int newLength3 = solution.compress(chars3);
        System.out.println(newLength3);
        System.out.println(Arrays.toString(Arrays.copyOf(chars3, newLength3)));
    }
}
