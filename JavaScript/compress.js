...
var compress = function(chars) {
    let currentIndex = 0; // Index to update the chars array
    let currentChar = chars[0]; // Current character
    let count = 1; // Current character's count
